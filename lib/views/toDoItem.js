      ...
      <div className="todo">
        {
          (() => {
            if (this.props.mode === 'create') {
              return <input className="new-todo-item-input" type="text" value={this.state.description} onChange={this.changeDescription} />;
            } else if (this.state.mode === 'edit') {
              return (
                <div>
              ...
              return (
                <div>
                  <input name="isComplete" type="checkbox" checked={this.state.isComplete} onChange={this.toggleComplete} />
                  <span className="to-do-description">{this.state.description}</span>
                </div>
              );
            }
          })()
